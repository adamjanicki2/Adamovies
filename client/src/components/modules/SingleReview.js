  ...
  render() {
    ...
    return (
      <div className="Review-container u-textCenter Title-link">
        ...
        <div className='movie-info'><h2>{convertDate(this.props.review.timestamp).split(' ')[0]}</h2><h2 className='bar-spacing'>|</h2><h2>{this.props.review.rating}%</h2><h2 className='bar-spacing'>|</h2><FontAwesomeIcon className='card-heart' icon={faHeart} size={'2x'}/><h2>{this.props.review.likes}</h2></div>
        </div>
