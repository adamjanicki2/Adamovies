...
class SingleComment extends Component {
  ...
  render() {
    ...
    return (
      <div className={"u-bordering Comment-body "+this.props.color}>
        ...
        <div className="u-bold comment-username u-bordering" onClick={() => {this.navigateProfile(this.props.color, this.props.userId)}}>
          {this.props.commenter+':'} 
        </div>
        <div className='u-bordering comment-block'>{' '+this.props.content}</div>
      </div>
    );
  }
}
