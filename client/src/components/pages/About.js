    ...
    return (
      <div className='bg'>
        ...
        <p className='about-text'>Adamovies is an interactive site for movie and TV show geeks who like to read about what they watch. Reviews are published by admin users for everyone to see. 
          ...
          Also, I'll be writing writing weekly reviews of shows that are currently releasing (for example WandaVision). If you want to write reviews for the site, feel free to <a className='mail-link' href="mailto:adamoviessite@gmail.com">email me</a> and ask.
          <br></br><br></br>
