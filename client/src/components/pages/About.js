    ...
    return (
      <div className='bg'>
        ...
        <p className='about-text'>Adamovies is an interactive site for movie and TV show geeks who like to read about what they watch. Reviews are published by admin users for everyone to see. 
          ...
          There is a comment section where signed in users are able to leave their thoughts, and even interact with other users and admin, as the comments update in real-time. Users can use the @username function to get the attention
          of other users. When '@-ed', the '@-ed' user will receive a notification in their profile, as well as seeing their username in bold.
          <br></br><br></br>
          ...
          Also, I'll be writing writing weekly reviews of shows that are currently releasing (for example WandaVision). If you want to write reviews for the site, feel free to @ me in the comments, or <a className='mail-link' href="mailto:adamoviessite@gmail.com">email me</a> and ask.
          <br></br><br></br>
