...
class Stats extends Component {
  ...
  componentDidMount(){
    window.scrollTo(0, 0);
    document.title = 'Site Statistics | Adamovies';
    ...
    return (
      <div className='bg'>
        ...
        <ul>
            ...
            <li className='stats-text'>The most liked review is <Link to={`/review/${this.state.reviews.maxLikes._id}`} className='u-bold movie-link'>{this.state.reviews.maxLikes.title+`${this.state.reviews.maxLikes.season !== 0? ` S${this.state.reviews.maxLikes.season}`+`${this.state.reviews.maxLikes.episode !== 0? `E${this.state.reviews.maxLikes.episode}` : ''}` : ''}`}</Link> with <span className='u-bold'>{this.state.reviews.maxRating.likes}</span> likes</li>
            <li className='stats-text'>The most commented review is <Link to={`/review/${this.state.comments.maxCommented._id}`} className='u-bold movie-link'>{this.state.comments.maxCommented.title+`${this.state.comments.maxCommented.season !== 0? ` S${this.state.comments.maxCommented.season}`+`${this.state.comments.maxCommented.episode !== 0? `E${this.state.comments.maxCommented.episode}` : ''}` : ''}`}</Link> with <span className='u-bold'>{this.state.comments.maxAmount}</span> comments</li>
            <li className='stats-text'>The average review rating is <span className='u-bold'>{this.state.reviews.avg_rating}%</span></li>
            <li className='stats-text'><Link to={`/review/${this.state.reviews.maxRating._id}`} className='u-bold movie-link'>{this.state.reviews.maxRating.title+`${this.state.reviews.maxRating.season !== 0? ` S${this.state.reviews.maxRating.season}`+`${this.state.reviews.maxRating.episode !== 0? `E${this.state.reviews.maxRating.episode}` : ''}` : ''}`}</Link> is the highest rated review with a <span className='u-bold'>{this.state.reviews.maxRating.rating}%</span></li>
            <li className='stats-text'><Link to={`/review/${this.state.reviews.minRating._id}`} className='u-bold movie-link'>{this.state.reviews.minRating.title+`${this.state.reviews.minRating.season !== 0? ` S${this.state.reviews.minRating.season}`+`${this.state.reviews.minRating.episode !== 0? `E${this.state.reviews.minRating.episode}` : ''}` : ''}`}</Link> is the lowest rated review with a <span className='u-bold'>{this.state.reviews.minRating.rating}%</span></li>
